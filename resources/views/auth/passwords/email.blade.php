    ...
    <div class="flex flex-wrap justify-center">
        <div class="w-full max-w-sm">
            <div class="flex flex-col break-words bg-white boder border-2 shadow-md mt-20">
                ...
                <form class="py-10 px-5" method="POST" action="{{ route('password.email') }}">
                    @csrf
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="email" type="email" class="p-3 bg-gray-200 rounded form-input w-full @error('email') border-red-500 border @enderror" name="email" value="{{ old('email') }}" novalidate autocomplete="email" autofocus>
